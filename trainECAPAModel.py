...
from tools import *
from dataLoader import train_loader, target_loader
...
targetloader = target_loader(**vars(args))
targetLoader = torch.utils.data.DataLoader(targetloader, batch_size = args.batch_size, shuffle = True, num_workers = args.n_cpu, drop_last = True)
...
while(1):
	...
	loss, lr, acc = s.train_network(epoch = epoch, source_loader = trainLoader, target_loader = targetLoader)
